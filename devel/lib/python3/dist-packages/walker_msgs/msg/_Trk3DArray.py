...
class Trk3DArray(genpy.Message):
  _md5sum = "418628728267a097595ff80736ff85e7"
...
"""
  ...
  _slot_types = ['std_msgs/Header','walker_msgs/Trk3D[]','sensor_msgs/PointCloud2','sensor_msgs/LaserScan']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.trks_list:
        _x = val1
        buff.write(_get_struct_7fbf().pack(_x.x, _x.y, _x.vx, _x.vy, _x.yaw, _x.radius, _x.confidence, _x.class_id, _x.dangerous))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.vx, _x.vy, _x.yaw, _x.radius, _x.confidence, _x.class_id, _x.dangerous,) = _get_struct_7fbf().unpack(str[start:end])
